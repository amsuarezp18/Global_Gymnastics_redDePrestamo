sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.globalGym.controller.Prestamosadmin", {
		...
		_onButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("ModificarEstado", oBindingContext, fnResolve, "");
		...
		_onSearchFieldLiveChange: function(oEvent) {
			var sControlId = "sap_m_Page_0-content-build_simple_Table-1622500891107";
		...
		onInit: function() {
			...
			this.oRouter.getTarget("Prestamosadmin").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_Page_0-content-build_simple_Table-1622500891107",
				"groups": ["items"]
			}];
