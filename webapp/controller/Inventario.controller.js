sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.globalGym.controller.Inventario", {
		...
		_onSearchFieldSearch: function(oEvent) {
			var sControlId = "sap_m_Page_0-content-build_simple_Table-1622501952987";
		...
		_onLinkPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Mainadmin", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_Page_0-content-build_simple_Table-1622501952987",
				"groups": ["items"]
			}];
